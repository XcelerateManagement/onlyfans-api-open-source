...
| A login or sync that broke today | [Platform change](https://github.com/theonlyapi/onlyfans-api/issues/new?template=platform_breakage.yml) — the highest-value report here |
| A reproducible bug | [Bug report](https://github.com/theonlyapi/onlyfans-api/issues/new?template=bug_report.yml) |
