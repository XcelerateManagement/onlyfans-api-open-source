...
| A login or sync that broke today | [Platform change](https://github.com/XcelerateManagement/onlyfans-api-open-source/issues/new?template=platform_breakage.yml) — the highest-value report here |
| A reproducible bug | [Bug report](https://github.com/XcelerateManagement/onlyfans-api-open-source/issues/new?template=bug_report.yml) |
