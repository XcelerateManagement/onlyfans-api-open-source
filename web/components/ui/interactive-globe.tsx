...
const DEFAULT_MARKERS = [
  ...
  { lat: -28.00, lng: 153.43, label: "Gold Coast" },
...
export function InteractiveGlobe({
  ...
  dotColor = "rgba(245, 73, 0, ALPHA)",
  arcColor = "rgba(245, 73, 0, 0.5)",
  markerColor = "rgba(255, 122, 48, 1)",
  ...
  const draw = useCallback(() => {
    ...
    // Outer glow — orange tinted
    const glowGrad = ctx.createRadialGradient(cx, cy, radius * 0.8, cx, cy, radius * 1.5);
    glowGrad.addColorStop(0, "rgba(245, 73, 0, 0.04)");
    glowGrad.addColorStop(1, "rgba(245, 73, 0, 0)");
    ...
    ctx.strokeStyle = "rgba(245, 73, 0, 0.08)";
    ctx.lineWidth = 1;
    ctx.stroke();
