...
export const PartnershipIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const IntegrityIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const CookieIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
// API Component Icons
export const KeyIcon = ({ className, size = 24 }: { className?: string; size?: number }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const WebhookIcon = ({ className, size = 24 }: { className?: string; size?: number }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const DashboardIcon = ({ className, size = 24 }: { className?: string; size?: number }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const BookOpenIcon = ({ className, size = 24 }: { className?: string; size?: number }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
// Logo - Modern geometric accelerate symbol
export const BrandLogo = ({
  ...
  >
    ...
    {/* Triple chevron/arrow - acceleration symbol */}
    <path
      d="M10 20L18 12V17L12 20L18 23V28L10 20Z"
      fill="white"
      opacity="0.5"
    />
    <path
      d="M16 20L24 12V17L18 20L24 23V28L16 20Z"
      fill="white"
      opacity="0.75"
    />
    <path
      d="M22 20L30 12V17L24 20L30 23V28L22 20Z"
      fill="white"
    />
  </svg>
);
